...
const styles = StyleSheet.create({
  ...
  content: { padding: 24 },
  title: { fontSize: 28, fontWeight: '800', color: '#1a2e44', marginBottom: 4, letterSpacing: -0.5 },
  subtitle: { fontSize: 14, color: '#aaaaaa', marginBottom: 28 },
  hint: { color: '#aaaaaa', fontSize: 12, marginBottom: 10 },
  liveBtn: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  videoPlaceholder: { padding: 44, alignItems: 'center' },
  videoPlaceholderIcon: { fontSize: 56, marginBottom: 14 },
  videoPlaceholderText: { color: '#1a2e44', fontSize: 16, fontWeight: '700', marginBottom: 4 },
  videoPlaceholderSub: { color: '#aaaaaa', fontSize: 13 },
  videoSelected: { padding: 24, alignItems: 'center' },
  videoSelectedIcon: { fontSize: 44, marginBottom: 10 },
  ...
  videoSelectedName: { color: '#aaaaaa', fontSize: 12, marginBottom: 8 },
  tapToChange: { color: '#bbbbbb', fontSize: 12 },
  ...
  charCount: { color: '#bbbbbb', fontSize: 12, textAlign: 'right', marginTop: 4 },
  ...
  uploadBtnContent: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 },
  uploadBtnText: { color: '#ffffff', fontSize: 16, fontWeight: '700', textAlign: 'center' },
  ...
  qChipTextActive: { color: '#ffffff', fontWeight: '700' },
  goLiveConfirmBtn: {
