...
const styles = StyleSheet.create({
  ...
  content: { flex: 1 },
  title: { fontSize: 24, fontWeight: '700', color: '#1a2e44', paddingHorizontal: 16, marginBottom: 16 },
  ...
  emptyText: { color: '#1a2e44', fontSize: 16, fontWeight: '600', marginBottom: 6 },
  ...
  profileInfo: { flex: 1 },
  profileUsername: { fontSize: 14, fontWeight: '700', color: '#1a2e44' },
