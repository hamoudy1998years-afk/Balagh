...
const styles = StyleSheet.create({
  ...
  searchInput: { flex: 1, color: '#1a2e44', fontSize: 15, paddingVertical: 14 },
  clearBtn: { color: '#bbbbbb', fontSize: 16, padding: 4 },
  categoryList: { marginBottom: 14, flexGrow: 0 },
  ...
  emptyText: { color: '#1a2e44', fontSize: 17, fontWeight: '700', marginBottom: 6 },
  emptySubtext: { color: '#aaaaaa', fontSize: 14 },
  ...
  profileInfo: { flex: 1 },
  profileUsername: { fontSize: 15, fontWeight: '700', color: '#1a2e44' },
  profileFullName: { fontSize: 13, color: '#666666', marginTop: 2 },
  profileFollowers: { fontSize: 12, color: '#aaaaaa', marginTop: 2 },
  profileFollowBtn: {
  ...
  gridViews: { color: '#fff', fontSize: 11, fontWeight: '700' },
});
